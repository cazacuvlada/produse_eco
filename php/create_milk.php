...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    do{
        ...
        $sql = "INSERT INTO milk (produse_milk,magazin,pret_milk)
        VALUES ('$produse_milk' ,'$magazin','$pret_milk')";
...
?>
        <form method="post">
            ...
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Produse MilkMark</label>
<div class="col-sm-6">
...
<div class="col-sm-3 d-grid">
    <a style="color:lightslategray;background-color:white;" class="btn btn-outline-primary" href="../menu/milk_admin.php" role="button">Cancel</a>
</div>
            </div>
        </form>
    </div>
