...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $beer_shop=$_POST["beer_shop"];
   
   

    do{
        if(empty($beer_name)||empty ($alcohol) ||empty ($beer_shop)){
            $errorMessage = "All the fields are required";
            break;
        }
       
        //add a new book to DB
        $sql = "INSERT INTO beer (beer_name,alcohol,beer_shop)
        VALUES ('$beer_name' ,'$alcohol','$beer_shop')";
...
<div class="home-btn">
    <a href="../menu/beer_admin.php">BeerMaster Brewery </a>
</div>
...
?>
        <form method="post">
            ...
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Beer Name</label>
<div class="col-sm-6">
    <input type="text" class="form-control" name="beer_name" value="<?php echo $beer_name; ?>">
</div>
            </div>
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Alcohol</label>
<div class="col-sm-6">
    <input type="text" class="form-control" name="alcohol" value="<?php echo $alcohol; ?>">
</div>
            </div>
            <div class="row mb-3">
<label class="col-sm-3 col-form-label ">Beer_shop</label>
<div class="col-sm-6">
    <input type="text" class="form-control" name="beer_shop" value="<?php echo $beer_shop; ?>">
</div>
            </div>
...
<div class="col-sm-3 d-grid">
    <a style="color:lightslategray;background-color:white;" class="btn btn-outline-primary" href="../menu/beer_admin.php" role="button">Cancel</a>
</div>
            </div>
        </form>
    </div>
